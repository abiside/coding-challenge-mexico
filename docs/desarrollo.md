# Guía técnica / de desarrollo — Nifty Arbitrage Engine

> Referencia técnica y de arquitectura del proyecto (Laravel 13 + Sail + ReactPHP +
> Reverb). Para el **manual de usuario e instalación** ver [`README.md`](../README.md);
> para la arquitectura multiusuario en detalle ver
> [`docs/architecture/multiusuario.md`](architecture/multiusuario.md).
